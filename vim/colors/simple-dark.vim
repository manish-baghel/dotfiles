...
"
" Author: Manish Baghel (@manish-baghel)
" Inspired By: Zefei Xuan <zefei.xuan@gmail.com>
"
...
" General Colors
hi Normal       guifg=#d7d7d7   guibg=#161616   ctermfg=251    ctermbg=235       gui=none      cterm=none
...
" UI
hi LineNr       guifg=#999999   guibg=#161616   ctermfg=238    ctermbg=233       gui=none      cterm=none
hi CursorLineNr guifg=#afafaf   guibg=#444444   ctermfg=245    ctermbg=bg        gui=none      cterm=none
hi Pmenu        guifg=#999999   guibg=#363636   ctermfg=233    ctermbg=249       gui=none      cterm=none
